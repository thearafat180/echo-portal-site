...
const MostPopular = () => {
  ...
  return (
    <section className="bg-taara-cream py-20">
      <div className="mx-auto px-6 container">
        {/* Section Header */}
        <div className="mb-16 text-center">
          <div className="inline-flex items-center bg-taara-golden/20 mb-6 px-4 py-2 rounded-full font-medium text-taara-dark-brown text-sm">
            ⭐ Most Popular
          </div>
          ...
          <p className="mx-auto max-w-3xl text-taara-dark-brown/80 text-xl">
        ...
        <div className="gap-8 grid md:grid-cols-2 lg:grid-cols-4">
          {products
            .filter(product => product.displayMode.includes("popular"))
            .map((product, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden">
                ...
                {/* Image Thumbnails */}
                  ...
                  <div className="top-4 left-4 absolute">
                    <span className="bg-taara-golden px-3 py-1 rounded-full font-medium text-taara-charcoal text-xs">
                    Popular
                  </span>
                </div>
              ...
              {/* Product Content */}
              <div className="p-6">
                  <div className="mb-2 font-medium text-taara-brown text-sm">
                  {product.category}
                </div>

                  <h3 className="mb-2 font-display font-bold text-taara-charcoal group-hover:text-taara-golden text-xl transition-colors">
